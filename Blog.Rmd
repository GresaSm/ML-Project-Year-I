...
The aim is to bring an innovative and useful policy-making tool to address the informal economy, by illustrating how machine learning classification techniques can significantly benefit the public policy area, not only in policy-design, but also in policy evaluation and implementation [@loftis_mortensen_2018]. Among the main findings shown by our models is the strong relation between the variables associated to particular Working Characteristics of respondents and the likelihood of being classified as an informal or formal worker. 
...
Similar to our algorithm model, the authors argue that classification algorithms may learn from datasets containing past labour inspection findings and produce classifiers that effectively predict labour law violations, as well as provide understandable explanations for these predictions.
...
(b) Further the model was trained to be applied in the annual dataset of 2019, which naturally consisted of more observations
...
```{r fig3, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Table 1. Baseline and model scores"}
#knitr::include_graphics("/Users/gresasmolica/Downloads/Table 3.1.jpg")

image3<- readJPEG("/Users/gresasmolica/Downloads/Table 3.1.jpg")
grid.raster(image3)
```
...
```{r fig4, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Performance of models in 2019 quarter dataset"}
...
```{r fig5, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Performance of models in 2019 quarter dataset (Logistic Regression in the left, XGBoost in the centre, and Decision Tree in the right"}
...
```{r fig6, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Performance of models in 2019 dataset"}
...
```{r fig7, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Subset categories performance with the DT"}
...
```{r fig8, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Class distribution in 2021 dataset"}
...
```{r fig9, eval = TRUE, echo = FALSE, out.width = '100%', fig.cap = "Performance of DT model in the 2021 dataset"}
#knitr::include_graphics("/Users/gresasmolica/Downloads/DT in 2021_page-0001.jpg")

image9<- readJPEG("/Users/gresasmolica/Downloads/DT in 2021_page-0001.jpg")
grid.raster(image9)
```

The model was run with the 4 variables that make up the working characteristics subset. The evaluation score for
this model of the MCC has a score of 0.79. This implies that most of the labels are being predicted correctly.
